...
// 제도 자체에 대한 사실 안내. 해마다 바뀌는 금액(월 한도액 등)은 넣지 않고,
// 오래 유지되는 기준만 담는다 — 숫자를 잘못 안내하는 쪽이 더 위험하기 때문.
export const PROGRAM_FACTS = [
  {
    title: "누가 신청할 수 있나요",
    desc: "만 65세 이상이면 누구나 신청할 수 있어요. 65세 미만이라도 치매·뇌혈관질환 같은 노인성 질병이 있으면 대상이 돼요.",
  },
  {
    title: "결과는 언제 나오나요",
    desc: "신청한 날부터 보통 30일 안에 나와요. 방문조사와 의사소견서 제출이 늦어지면 더 걸릴 수 있어요.",
  },
  {
    title: "비용은 얼마나 내나요",
    desc: "급여 비용의 일부만 본인이 부담해요. 집에서 받는 재가급여가 시설급여보다 부담률이 낮고, 기초생활수급자는 면제, 차상위 등은 경감돼요. 식사비·상급침실료 같은 비급여는 따로 부담해요.",
  },
  {
    title: "등급은 계속 유지되나요",
    desc: "인정 유효기간이 정해져 있어 만료 전에 갱신 신청을 해야 해요. 첫 인정은 보통 1년이고, 갱신하면 등급에 따라 더 길게 인정받아요. 상태가 나빠지면 기간 중에도 등급 변경을 신청할 수 있어요.",
  },
] as const;
