...
// ⚠️ **80자를 넘기지 말 것.** 네이버 웹마스터도구가 "사이트 설명"과 "Open Graph 설명"
// 두 항목에서 80자 초과를 경고한다(2026-08-07 실측 — 이전 문구가 89자여서 둘 다 걸렸다).
// 공단·심평원 기관명은 뺐다 — 검색어로서의 값이 낮고 글자만 20자 넘게 먹는다.
// 대신 네 가지 유형 키워드와 핵심 속성(평가등급·비급여·인력)은 그대로 지킨다.
export const SITE_DESCRIPTION =
  "전국 요양원·요양병원·주야간보호·방문요양 2만8천여 곳의 평가등급·비급여 비용·인력 현황을 공공데이터로 비교하세요.";
