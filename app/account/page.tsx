...
export default function AccountPage() {
  ...
  if (!session?.user) {
    return (
      <main className="mx-auto max-w-md px-4 py-16 text-center">
        ...
        <p className="text-sm text-ink-500">계정 설정은 로그인 후 확인할 수 있어요.</p>
      </main>
    );
  }
  ...
  return (
    <main className="mx-auto max-w-xl px-4 py-8 pb-24">
      <h1 className="mb-1 text-xl font-bold text-ink-900">계정 설정</h1>
        ...
        {!confirming ? (
          ...
          <div className="rounded-xl bg-primary-50 p-4 text-center">
            <p className="mb-3 text-sm text-ink-700">
              정말 탈퇴하시겠어요? 관심시설·비교함 등 계정 정보가 모두 삭제되고 되돌릴 수 없어요.
            </p>
