...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/services/hospital`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/services/home`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/services/housekeeping`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/services/family`, changeFrequency: "monthly", priority: 0.85 },
